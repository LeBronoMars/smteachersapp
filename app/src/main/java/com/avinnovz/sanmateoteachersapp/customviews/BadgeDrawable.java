package com.avinnovz.sanmateoteachersapp.customviews;

/**
 * Created by jayan on 4/14/2017.
 * References: https://mobikul.com/adding-badge-count-on-menu-items-like-cart-notification-etc/
 * Credits to: Shubham Agarwal
 */
...
public class BadgeDrawable extends Drawable {
    ...
    public BadgeDrawable(Context context) {
        float mTextSize = context.getResources().getDimension(R.dimen.fontsize_badge);
